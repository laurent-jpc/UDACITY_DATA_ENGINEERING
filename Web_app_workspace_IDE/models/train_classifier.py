...
import warnings  # requested to managed get_scores with this version of sklearn
                 # according to https://stackoverflow.com/questions/43162506/undefinedmetricwarning
...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    for i in range(len(category_names)):
        # get a report, i.e.e a text, with classification results, including scores for 0, 1 and total
